...
const MIRROR: readonly string[] = [
  ...
  'chevronstart',
  'chevronend',
  // Ionicons and Expo's vector-icons spell these forward/back rather than
  // right/left, and they are among the most-used icons in React Native apps.
  'chevronforward',
  'chevronback',
  'arrowredo',
  'arrowundo',
  ...
  'caretleft',
  'caretright',
  // Material Community and Feather.
  'menuleft',
  'menuright',
  'pagefirst',
  'pagelast',
